...
if done_is_more_than_3 < 3 :
    ...
    print ("- [[https://fresh2refresh.com/sql-tutorial/][SQL Tutorial - Learn Best Guide For Beginners Online]] ;; Learn SQL Tutorial in easy way \n\n") # 북마크 만들어 생성하기 여기에 설명을 붙인다.
...
[[https://fresh2refresh.com/sql-tutorial/][SQL Tutorial - Learn Best Guide For Beginners Online]]
